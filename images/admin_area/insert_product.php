    ...
    <div class="container mt-3">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-outline mb-4 w-50 m-auto">
                ...
                <input type="text" name="product_keywords" id="product_keywords"class="form-control" placeholder="Enter product keywords" autocapitalize="off" required="required">  
            </div>
    <!--categories-->
     <div class="form-outline mb-4 w-50 m-auto">
     ...
     <div class="form-outline mb-4 w-50 m-auto">
         ...
         ?>
            ...
            <div class="form-outline mb-4 w-50 m-auto">
                ...
                <input type="text" name="product_price" id="product_price"class="form-control" placeholder="Enter product price" autocapitalize="off" required="required">  
            </div>
             <!--Price-->
            <div class="form-outline mb-4 w-50 m-auto">
